...
function SignUp() {
    ...
    const signUp = (event) => {
        ...
        postSignUp(body)
            .then((response) => {
                setIsAble(true);
                setUser({ ...user, name: form.name, profilePictureURL: form.profilePictureURL, token: response.data });
                navigate('/homepage');
            })
            .catch((response) => {
                setIsAble(true);
        ...
        <Content>
            ...
            <Form>
                <form onSubmit={signUp}>
                    <input type="text" name='name' value={form.name} onChange={handleForm} placeholder='Nome' disabled={!isAble} />
                    ...
                    <input type="password" name='confirmPassword' value={form.confirmPassword} onChange={handleForm} placeholder='Confirme sua senha' disabled={!isAble} />
                    <button type="submit">
